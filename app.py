...
st.sidebar.markdown("Para acceder a todos los assets en el repositorio, puedes hacerlo [aquí]()")
...
with tab2:
    if selection == "Ejercicio 1":
        ...
        set_img(
            "assets/propiedades-asset-01.png",
            "Fig. 1. Propiedades del asset-01",
            "Imágenes del asset-01",
        )
        set_img(
            "assets/propiedades-mediaarea.png",
        ...
        set_img(
            "assets/propiedades-asset-02.png",
            "Fig. 1. Propiedades del asset-02",
            "Imágenes del asset-02",
        )
        set_img(
            "assets/propiedades-mediaarea-asset-02.png",
            "Fig. 2. Propiedades del MediaInfo"
        )
    elif selection == "Ejercicio 3":
        st.warning('Es posible que dado que los vídeos tienen formato `.mpg` no se puedan reproducir en algunos navegadores. En caso de que no se reproduzcan, se encuentran en el repositorio.')
        set_video(
            "pec2_dvd",
            "assets/pec2_dvd.mpg",
        )
        set_video(
            "pec2_dvd_m2_n8",
            "assets/pec2_dvd_m2_n8.mpg",
        )
        set_video(
            "pec2_dvd_m3_n15",
            "assets/pec2_dvd_m3_n15.mpg",
        )
        set_img(
            "assets/propiedades-pec2_dvd.png",
            "Fig. 1. Propiedades del pec2_dvd"
        )
        set_img(
            "assets/propiedades-pec2_dvd_m3_n15.png",
